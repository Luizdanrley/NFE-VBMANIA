...
Public Class LerXmlNFE
    ...
    Public Function LerNFE(ByVal CaminhoNFE As String) As NotaEletronica
        ...
        'OPEN FILE DIALOG PARA LOCALIZAR O ARQUIVO
        ' Displays an OpenFileDialog so the user can select a Cursor.
        Dim openFileDialog1 As New OpenFileDialog()
        openFileDialog1.Filter = "xml Files|*.xml"
        openFileDialog1.Title = "Selecione a nota fiscal eletrônica!"
        ...
        If openFileDialog1.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
            ...
            '  CaminhoNFE = openFileDialog1.OpenFile()

            dados.Load(openFileDialog1.OpenFile())
                ...
                For Each InnerNode2 As XmlNode In InnerNode.ChildNodes
                    ...
                    If (InnerNode2.Name = "ide") Then
                        ...
                        Else
                            ...
                            NotaLida.infNFE.Ide.tpNF = InnerNode2.ChildNodes(9).InnerText
                            NotaLida.infNFE.Ide.cMunFG = InnerNode2.ChildNodes(10).InnerText
                            'ContarEntradas -= 1
                        End If
                    ...
                    ElseIf (InnerNode2.Name = "det") Then
                        ...
                        Else
                            ...
                            Detalhamento.Prod.genero = InnerNode2.ChildNodes(0).ChildNodes(4).InnerText
                            Detalhamento.Prod.CFOP = InnerNode2.ChildNodes(0).ChildNodes(5).InnerText
                            Detalhamento.Prod.uCom = InnerNode2.ChildNodes(0).ChildNodes(6).InnerText.Replace(".", ",")
                            Detalhamento.Prod.qCom = InnerNode2.ChildNodes(0).ChildNodes(7).InnerText.Replace(".", ",")
                            Detalhamento.Prod.vUnCom = InnerNode2.ChildNodes(0).ChildNodes(8).InnerText.Replace(".", ",")
                            Detalhamento.Prod.vProd = InnerNode2.ChildNodes(0).ChildNodes(9).InnerText.Replace(".", ",")
                            Detalhamento.Prod.cEANTrib = InnerNode2.ChildNodes(0).ChildNodes(10).InnerText
                            Detalhamento.Prod.uTrib = InnerNode2.ChildNodes(0).ChildNodes(11).InnerText.Replace(".", ",")
                            Detalhamento.Prod.qTrib = InnerNode2.ChildNodes(0).ChildNodes(12).InnerText.Replace(".", ",")
                            Detalhamento.Prod.vUnTrib = InnerNode2.ChildNodes(0).ChildNodes(13).InnerText.Replace(".", ",")
                        End If

                        For Each InnerNode3 As XmlNode In InnerNode2.ChildNodes
                            If (InnerNode3.Name = "prod") Then
                                For Each InnerNode4 As XmlNode In InnerNode3.ChildNodes
                                    If (InnerNode4.Name = "med") Then
                                        Dim Cmed As New med
                                        Cmed.nLote = InnerNode4.ChildNodes(0).InnerText
                                        Cmed.qLote = InnerNode4.ChildNodes(1).InnerText.Replace(".", ",")
                                        Cmed.dFab = InnerNode4.ChildNodes(2).InnerText
                                        Cmed.dVal = InnerNode4.ChildNodes(3).InnerText
                                        Cmed.vPMC = InnerNode4.ChildNodes(4).InnerText.Replace(".", ",")
                                        Detalhamento.Prod.Med.Add(Cmed)
                                    End If
                                Next
                            End If
