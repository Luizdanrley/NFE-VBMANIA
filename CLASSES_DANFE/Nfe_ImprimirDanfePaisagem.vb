...
Public Class Nfe_ImprimirDanfePaisagem
    ...
    Private V_DFaturamento As DFaturamento
    Private V_DTransportadora As DTransportadora
    Private V_DISSQN As DISSQN
    Private I_DDadosNfe As DDadosNfe
    ...
    Public Property AddProdutosDanfe() As IList(Of ProdutoDanfe)
        ...
        End Set
    End Property
    Public WriteOnly Property Dados_Nfe() As DDadosNfe
        Set(ByVal Valor As DDadosNfe)
            I_DDadosNfe = Valor
        End Set
    End Property
    ...
    Public WriteOnly Property Valores_Nota() As DValores
        ...
        End Set
    End Property
    Public WriteOnly Property Faturamento() As DFaturamento
        Set(ByVal Valor As DFaturamento)
            V_DFaturamento = Valor
        End Set
    End Property
    ...
    Public Sub VisualizarImpressao()
        ...
        If I_DDadosNfe.IMP_DV = "SIM" Then
            Prv_Visualizador.Document = Doc_VisualizarDanfe

            Prv_Visualizador.FormBorderStyle = 2
            Prv_Visualizador.PrintPreviewControl.Zoom = 0.8
        ...
        'ImpressoraPadrao = Doc_VisualizarDanfe.PrinterSettings.PrinterName

        ''Define a Nova Impressora para Imprimir
        'Doc_VisualizarDanfe.PrinterSettings.PrinterName = "PDF_NFE"

        'Doc_VisualizarDanfe.Print()

        'Volta para Impressora Padrão
        'Doc_VisualizarDanfe.PrinterSettings.PrinterName = ImpressoraPadrao
    ...
    Private Sub InserirCabecalho(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Gra_Saida.Graphics.DrawString(Int32.Parse(I_DDadosNfe.NUMERO_NFE).ToString("000000000"), Font12_B, Brushes.Black, 6.3, 17)
        ...
        For Each PDanfe As ProdutoDanfe In V_PRODUTOS
            ...
            If ContaProdutos1 < Conte Then
                ...
                If AlturaLinha > LimitePagina And ContaProd < V_PRODUTOS.Count Then
                    Conte = Conte + 1
                    AlturaLinha = 52
                    LimitePagina = 150
                End If
        ...
        Gra_Saida.Graphics.DrawImage(CodigoBarra.DrawBarCode(I_DDadosNfe.CHAVEACESSO_NFE), 184, 2, 100, 11)
    ...
    Private Sub Preencher_Dados_Danfe(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        'FATURAMENTO
        Gra_Saida.Graphics.DrawString(V_DFaturamento.Faturamento, FontArial7, Brushes.Black, 31, 71)
        ...
        Gra_Saida.Graphics.DrawString(V_DValores.VALOR_TOTAL_PRODUTOS, Font10, Brushes.Black, New RectangleF(242, 78.2, 44, Font10.Height), Alinhamento)
        ...
        Gra_Saida.Graphics.DrawString(V_DValores.VALOR_TOTAL_NOTA, Font10, Brushes.Black, New RectangleF(244, 85.2, 42, Font10.Height), Alinhamento)
        ...
        Gra_Saida.Graphics.DrawString(S_INFOCOMP.DADOSADIC, Font5, Brushes.Black, New RectangleF(31, 173.2, 190, 30), Alinhamento)
    ...
    Private Sub CamposdemaisPaginas(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Gra_Saida.Graphics.DrawLine(pen, 23, 52, 287, 52)
        'CODIGO PRODUTO
        Gra_Saida.Graphics.DrawLine(pen, 64, 48, 64, 163)
        ...
        Gra_Saida.Graphics.DrawLine(pen, 31, 163, 287, 163)
        Gra_Saida.Graphics.DrawLine(pen, 31, 170, 287, 170)
        Gra_Saida.Graphics.DrawLine(pen, 31, 177, 287, 177)
        ...
        Gra_Saida.Graphics.DrawString("ALÍQ", Font5, Brushes.Black, 271.5, 48.2)
        Gra_Saida.Graphics.DrawString("ICMS", Font5, Brushes.Black, 271.5, 49.8)
        Gra_Saida.Graphics.DrawString("ALÍQ", Font5, Brushes.Black, 281, 48.2)
        Gra_Saida.Graphics.DrawString("IPI", Font5, Brushes.Black, 282, 49.8)
        ...
        For Each PDanfe As ProdutoDanfe In V_PRODUTOS
            ...
            If ContaProdutos < Conte Then
                ...
                Else
                    ...
                    If ControlaImpressao = 0 Then
                        Gra_Saida.Graphics.DrawLine(pen, 31, AlturaLinha, 287, AlturaLinha)
                    Else
                        Gra_Saida.Graphics.DrawLine(pen, 23, AlturaLinha, 287, AlturaLinha)
                    End If
                End If
                AlturaLinha += 1.0
                Gra_Saida.Graphics.DrawString(PDanfe.DCodigoProd, Font6, Brushes.Black, 31, AlturaLinha)
                Gra_Saida.Graphics.DrawString(PDanfe.DDescricao, Font6, Brushes.Black, 65, AlturaLinha)
                ...
                For Each LinhaAdi In PDanfe.LinhaProd
                    ...
                    SLinhaLote &= " " & LinhaAdi.ToString
                    If ContaPreen = 3 Then
                        Gra_Saida.Graphics.DrawString(SLinhaLote, Font5, Brushes.Black, 65, AlturaLinha)
                        ContaPreen = 0
                        SLinhaLote = ""
                        AlturaLinha += 2.8
                    End If
                ...
                If AlturaLinha > LimitePagina Then
    ...
    Private Sub InserirTextos(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Gra_Saida.Graphics.DrawString("ALÍQ", Font5, Brushes.Black, 271.5, 111.2)
        Gra_Saida.Graphics.DrawString("ICMS", Font5, Brushes.Black, 271.5, 112.9)
        Gra_Saida.Graphics.DrawString("ALÍQ", Font5, Brushes.Black, 281, 111.2)
        Gra_Saida.Graphics.DrawString("IPI", Font5, Brushes.Black, 282, 112.9)
    ...
    Public Sub DesenharRetangulos(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Gra_Saida.Graphics.DrawLine(pen, 31, 54, 287, 54)
        Gra_Saida.Graphics.DrawLine(pen, 31, 61, 287, 61)
        Gra_Saida.Graphics.DrawLine(pen, 31, 68, 287, 68)
        Gra_Saida.Graphics.DrawLine(pen, 31, 75, 287, 75)
        Gra_Saida.Graphics.DrawLine(pen, 31, 82, 287, 82)
        Gra_Saida.Graphics.DrawLine(pen, 31, 89, 287, 89)
        Gra_Saida.Graphics.DrawLine(pen, 31, 96, 287, 96)
        Gra_Saida.Graphics.DrawLine(pen, 31, 103, 287, 103)
        Gra_Saida.Graphics.DrawLine(pen, 31, 110, 287, 110)
        ...
        'LINHA PRODUTOS 5 CENTIMETROS
        Gra_Saida.Graphics.DrawLine(pen, 31, 115, 287, 115)

        'CODIGO PRODUTO
        Gra_Saida.Graphics.DrawLine(pen, 64, 110, 64, 163)
        'DESCRIÇÃO DOS PRODUTOS
        ...
        Gra_Saida.Graphics.FillRectangle(Brushes.LightGray, 25, 173, 5, 27)
    End Sub
